...
function writeChislo(num){
    ...
    let dec2 = ["десять", "одинадцать", "двенадцать", "тринадцать", "четырнадцать", "пятнадцать", "шестнадцать", "семнадцать", "восемнадцать", "девятнадцать"]
    let edin = ["ноль", "один", "два", "три", "четыре", "пять", "шесть", "семь", "восемь", "девять"]
let answer = 0;
let string = "";
let string2 = "";

for(let i=1; i<sotni.length; i++){
...
let numberString = "сто тридцать шесть";
